...
from .views import RegisterAPI,LoginAPI,DeleteAPI,VerifyEmail,ChangePasswordView,ChangeEmailView
...
urlpatterns = [
    ...
    path('api/changeemail/<str:id>/', ChangeEmailView.as_view(), name='ChangeEmail'),
